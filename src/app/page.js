...
const rooms = [
  {
    ...
    description:
      "Sunlit interiors with plush bedding, Smart TV, Wi-Fi, and a serene residential view.",
    tag: "Most Popular",
  ...
  },
  {
    ...
    description:
      "Spacious layout designed for business or family stays with work desk and upgraded amenities.",
  ...
  },
  {
    ...
    description:
      "Refined suite with kitchenette, lounge seating, refrigerator, and personalized concierge service.",
    tag: "Best Experience",
...
const bookingPartners = [
  ...
  },
  {
    ...
    note: "Direct booking · Free cancellation",
    tag: "Official",
    highlight: false,
  ...
  {
    name: "Booking.com",
    note: "Free Wi-Fi · Free cancellation",
    tag: "Popular",
    highlight: false,
...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      "Staff behaviour is good and proper guidance. A truly smooth experience from check-in to check-out.",
  },
  {
    ...
    rating: 5,
    quote:
      "Amazing hospitality and delicious food. The way people welcome us is just superb — I recommend it to all my friends.",
  },
  {
    name: "Trisha Alisha",
    role: "Google Review",
    rating: 5,
    quote:
      "Extremely polite and helpful staff. Rooms and washrooms are clean and neat. I'll definitely visit again and again.",
  },
  {
    name: "John Luke",
    role: "Google Review",
    rating: 5,
    quote:
      "Spacious, clean rooms and very helpful staff. The breakfast is absolutely delicious. Management is excellent.",
  },
];
...
const policyHighlights = [
  ...
  "Smoke-free property",
  "Credit cards, debit cards & NFC payments accepted",
  "Couples must be married to book",
  "Child-friendly · No pets allowed",
];
const transportHighlights = [
  "Free self and valet parking",
  "Airport shuttle available (extra charge)",
  "Local shuttle and car rental onsite",
  "Concierge-managed pickups and drop-offs",
];
const businessHighlights = [
  "Meeting rooms and business Wi-Fi",
  "24/7 front desk and wake-up calls",
...
// Scroll gallery images (use existing repo images)
const scrollGallery = [
  { src: "/images/hero-lobby.jpg", label: "Lobby & Lounge" },
  { src: "/images/dining.jpg", label: "Dining" },
  { src: "/images/rooms/deluxe-king.jpg", label: "Deluxe King Room" },
  { src: "/images/rooms/executive-suite.jpg", label: "Executive Suite" },
];
...
export default function Home() {
  ...
  // ✅ WhatsApp redirect + prefilled details
  const handleSearch = () => {
    const phone = "919565656100"; // WhatsApp number (country code included, no +)

    const textLines = [
      "Hello The Arcas Hotel,",
      "",
      "I want to check availability:",
      `Check-in: ${checkIn} (${formatWeekday(checkIn)})`,
      `Check-out: ${checkOut} (${formatWeekday(checkOut)})`,
      `Guests: ${guests}`,
      `Nights: ${nights}`,
      "",
      "Please share available rooms and best options.",
    ];
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-[95vh] overflow-hidden bg-white">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-6 py-28 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
          ...
          <div className="space-y-9">
            ...
            <p className="max-w-[480px] text-[17px] leading-[1.75] text-muted">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              >
                <Phone className="h-4 w-4" /> WhatsApp to Book
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2 sm:grid-cols-4">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-black/8 bg-white p-4 shadow-sm hover:shadow-md transition-shadow"
                >
                  <p className="text-[27px] font-bold leading-none tracking-tight text-foreground">
                    {stat.value}
                  </p>
                  <p className="mt-1.5 text-[10px] font-bold uppercase tracking-[0.24em] text-muted">
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="absolute -left-6 top-6 z-20 hidden w-52 rounded-2xl border border-black/10 bg-white/96 p-4 shadow-2xl backdrop-blur-sm lg:block">
              ...
              <p className="mt-2.5 text-[15px] font-semibold text-foreground">
                Executive Suite
              </p>
              ...
              <div className="mt-3 border-t border-black/8 pt-3">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-1.5 rounded-full bg-foreground px-3 py-1.5 text-[11px] font-bold text-white"
                >
            ...
            <div className="absolute -right-4 bottom-12 z-20 hidden w-52 rounded-2xl border border-black/10 bg-white/96 p-4 shadow-2xl backdrop-blur-sm lg:block">
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <Star
                    ...
                    className={`h-3.5 w-3.5 ${
                      i <= 4 ? "fill-amber-400 text-amber-400" : "fill-black/10 text-black/10"
                    }`}
                  />
                ))}
              </div>
              ...
              <p className="mt-1.5 text-[12px] leading-snug text-muted">
                Highly rated for cleanliness, comfort & attentive service.
              </p>
            </div>

            <div className="relative aspect-[3/4] w-full max-w-[420px] overflow-hidden rounded-[2.5rem] bg-surface-muted shadow-2xl shadow-black/15">
              <Image
        ...
        <div className="overflow-hidden rounded-[1.6rem] border border-black/12 bg-white/90 shadow-2xl shadow-black/12 backdrop-blur-xl">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-black/6 bg-surface-muted/40 px-5 py-3">
            ...
            <p className="text-[12px] text-muted">
              {nights} night{nights !== 1 ? "s" : ""} · {guests} guest{+guests !== 1 ? "s" : ""} · Call for group bookings
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto w-full max-w-6xl px-6 pt-24">
          ...
          <h2 className="mt-3 font-[family-name:var(--font-display)] text-[36px] font-bold leading-tight text-foreground">
            Scroll to explore the spaces.
          </h2>
          <p className="mt-3 max-w-xl text-[15px] leading-[1.8] text-muted">
            As you scroll, the visuals change seamlessly — from the lobby to dining and signature rooms.
          </p>
        </div>

        <div ref={galleryRef} className="relative">
          <div className="mx-auto grid w-full max-w-6xl gap-10 px-6 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            {/* Visual */}
            <div className="relative overflow-hidden rounded-[2rem] border border-black/10 bg-surface-muted shadow-2xl">
              <div className="relative aspect-[4/3] w-full">
                {scrollGallery.map((img, i) => (
                  <Image
                    key={img.src}
                    src={img.src}
                    alt={img.label}
                ...
                <div className="absolute bottom-5 left-5 right-5 rounded-xl border border-white/15 bg-black/45 p-4 backdrop-blur-md">
                  <p className="text-[10px] font-bold uppercase tracking-[0.24em] text-white/60">
                    Scene {activeScene + 1} of {scrollGallery.length}
                  </p>
                  <p className="mt-1 text-[14px] font-semibold text-white">
                    {scrollGallery[activeScene]?.label}
                  </p>
                </div>
              </div>
            </div>
                ...
                >
                  <p
                    className={`text-[10px] font-bold uppercase tracking-[0.25em] ${
                      i === activeScene ? "text-white/60" : "text-muted"
                    }`}
                  >
                    Stop {i + 1}
                  </p>
                  <p
                    className={`mt-2 text-[16px] font-semibold ${
                      i === activeScene ? "text-white" : "text-foreground"
                    }`}
                  >
                    {img.label}
                  </p>
                  <p
                    className={`mt-2 text-[13px] leading-relaxed ${
                      i === activeScene ? "text-white/70" : "text-muted"
                    }`}
                  >
                    Keep scrolling to continue the tour.
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-7">
            ...
            <div className="space-y-3.5">
              {[
                ...
                "Doctor on call · Daily housekeeping",
              ].map((item) => (
                <div key={item} className="flex items-center gap-3 text-[14px] text-muted">
                  <CheckCircle className="h-4 w-4 flex-shrink-0 text-foreground" />
                  {item}
                </div>
              ))}
            </div>
            <Link
              href="/about"
              className="group mt-2 inline-flex items-center gap-2 border-b border-foreground/20 pb-0.5 text-[13px] font-bold text-foreground hover:border-foreground transition-colors"
            >
              Our Story{" "}
                ...
                >
                  <div
                    className={`flex h-11 w-11 items-center justify-center rounded-xl ${
                      idx % 2 === 0 ? "bg-surface-muted text-foreground" : "bg-white/10 text-white"
                    }`}
                  >
                  ...
                  <p
                    className={`mt-2 text-[13px] leading-relaxed ${
                      idx % 2 === 0 ? "text-muted" : "text-white/65"
                    }`}
                  >
                    {item.description}
                  </p>
      ...
      <section id="rooms" className="bg-[#f4f4f4] scroll-mt-8">
        <div className="mx-auto w-full max-w-6xl px-6 py-28">
          <div className="flex flex-wrap items-end justify-between gap-6 mb-14">
            ...
            <Link
              href="/rooms"
              className="group inline-flex items-center gap-2 text-[13px] font-bold text-foreground"
            >
              View all rooms{" "}
              <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
                ...
                <div className="space-y-4 p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {room.features.map((f) => (
                      <span
                        key={f}
                        className="rounded-full border border-black/8 bg-surface-muted px-3 py-1 text-[11px] font-medium text-foreground"
                      >
                        {f}
                      </span>
                    ))}
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-28">
        <div className="mb-14 space-y-3">
          ...
          <p className="max-w-lg text-[15px] text-muted">
            Available across all major booking platforms.
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-5 rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-0.5 text-[13px] text-muted">
              Call us for group bookings or special requests — no platform fees.
            </p>
          </div>
          <a
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {[
              ...
              return (
                <div
                  key={sec.label}
                  className="rounded-2xl border border-black/10 bg-white p-7 shadow-sm transition-shadow hover:shadow-md"
                >
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-28">
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-[1.75rem] border border-black/10 bg-white p-8 transition-shadow hover:shadow-xl">
            ...
            <p className="mt-7 text-[10px] font-bold uppercase tracking-[0.3em] text-muted">
              Health & Safety
            </p>
            <h2 className="mt-2 font-[family-name:var(--font-display)] text-[26px] font-bold leading-snug text-foreground">
          ...
          <div className="rounded-[1.75rem] bg-foreground p-8 transition-shadow hover:shadow-2xl hover:shadow-black/20">
            ...
            <p className="mt-7 text-[10px] font-bold uppercase tracking-[0.3em] text-white/45">
              Sustainability
            </p>
            <h2 className="mt-2 font-[family-name:var(--font-display)] text-[26px] font-bold leading-snug text-white">
              Responsible hospitality.
            </h2>
            <ul className="mt-6 space-y-3.5">
              {sustainabilityHighlights.map((item) => (
                <li key={item} className="flex items-start gap-3 text-[13px] text-white/65">
                  <Leaf className="mt-0.5 h-4 w-4 flex-shrink-0 text-white" />
                  {item}
                </li>
              ))}
            </ul>
        ...
        <div className="mx-auto w-full max-w-6xl px-6 py-28">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="group relative rounded-2xl border border-black/10 bg-white p-7 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-xl"
              >
        ...
        <div className="grid gap-16 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-7">
            ...
            <div className="space-y-4">
              {[
                {
                  icon: MapPin,
                  text: "Khargapur Plot no 4, STP Road, Ganpati Vihar, Gomti Nagar, Lucknow, UP 226010",
                },
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
              <p className="mb-5 text-[10px] font-bold uppercase tracking-[0.28em] text-muted">
                Nearby
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={place}
                    className="flex items-center justify-between border-b border-black/5 pb-3 text-[13px] last:border-0 last:pb-0"
                  >
            ...
            <div className="rounded-2xl bg-foreground p-6 text-white">
              ...
              <p className="mt-2 text-[12px] leading-relaxed text-white/60">
                Airport transfers, local shuttles, and private car rentals arranged by our concierge.
              </p>
              <Link
                href="/contact"
                className="mt-4 inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-[12px] font-bold text-white transition hover:bg-white hover:text-foreground"
              >
        ...
        <div className="relative mx-auto w-full max-w-6xl overflow-hidden px-6 py-24">
          ...
          <div className="relative flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
                href="/contact"
                className="group inline-flex items-center justify-center gap-2.5 rounded-full bg-white px-8 py-4 text-[13px] font-bold text-foreground shadow-lg transition hover:bg-white/90"
              >
                Book with Our Team{" "}
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
              </Link>
              <a
                href="tel:+919565656100"
                className="inline-flex items-center justify-center gap-2.5 rounded-full border border-white/20 px-8 py-4 text-[13px] font-bold text-white transition hover:bg-white/10"
              >
